...

{
  ...
  # Ensure dconf is available (needed for dark mode in Electron/GTK apps like 1Password)
  programs.dconf.enable = true;

  # 1Password (CLI + GUI with browser integration)
  ...
  environment.systemPackages = with pkgs; [
   # neovim managed by flake (see nvim-module.nix)
   git
   claude-code
   vesktop
   heroic
